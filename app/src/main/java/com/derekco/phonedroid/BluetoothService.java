...
/**
 * This class does all the work for communicating via Bluetooth. Anything having to do with establishing,
 * managing, or communicating via a bluetooth connection should go here.
 */
...
public class BluetoothService {
    ...
    private static final String NAME_SECURE = "PhonedroidSecure";
    private static final String NAME_INSECURE = "PhonedroidInsecure";
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Log.d(TAG, "finished cancelling threads, starting connected thread");
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothConstants.TOAST, "Unable to connect to device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                if (secure) {
                    Log.d(TAG, "creating new secure listening socket");
                    tmp = mBluetoothAdapter.listenUsingRfcommWithServiceRecord(NAME_SECURE,
                            MY_UUID_SECURE);
                } else {
                    Log.d(TAG, "creating new insecure listening socket");
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothConstants.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
                Log.d(TAG, "sending message: " + buffer.toString());
            } catch (IOException e) {
